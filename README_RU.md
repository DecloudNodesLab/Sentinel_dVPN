...
Также, для продвинутых пользоветелей, [создан перечень доступных переменных](/Software/Sentinel%20dVPN/VARIABLES.md) с коротким описанием.
...
Также, если открыть Ваш адрес sentinel в Explorer, Вы можете увидеть наличие транзакций обновления статуса Вашей dVPN ноды.
